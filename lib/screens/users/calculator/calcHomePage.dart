...
import 'package:ephysicsapp/screens/users/calculator/calcList.dart';
...
class HomeWidgetState extends State<CalcHomePage>
      ...
      body: new TabBarView(
        ...
        children: tabs.map((Tab tab) {
          ...
          if (tab.text == tabs[1].text)
            ...
            section = "1";
          return CalcList(section: section);
        }).toList(),
      ),
      floatingActionButton: isLoggedIn()
          ? FloatingActionButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => AddCalculator()),
                );
              },
              child: Icon(
                Icons.add,
