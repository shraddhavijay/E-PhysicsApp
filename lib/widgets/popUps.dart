...
Future<void> onCalcDelete(
    {String moduleID, String section, BuildContext context}) {
  return showDialog(
    context: context,
    builder: (context) => new AlertDialog(
      title: new Text('Are you sure?'),
      content: new Text('Do you want to delete this Calculator?'),
      actions: <Widget>[
        new GestureDetector(
          onTap: () => Navigator.of(context).pop(false),
          child: Text(
        ...
        new GestureDetector(
          onTap: () async {
            deleteCalculator(section: section, moduleID: moduleID);
            Navigator.of(context).pop(false);
          },
          child: Text(
            "YES",
